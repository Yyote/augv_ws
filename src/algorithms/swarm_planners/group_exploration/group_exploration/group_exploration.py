...
class Explorer(Node):
    ...
    def exploration_loop(self):
        ...
        # line_id = self.find_most_lenght_line(lines)
        # contour_id = self.find_countour_with_most_point_intensivity(contours)
        # if contour_id == None:
        #     return

        # # goal = self.get_center_of_mass(contours[contour_id])
        # goal = self.find_line_center(lines[line_id][0])
