...
log_name = "group_exploration2024-03-18_12-32-27.json"
log_file = f"/home/leev/simulation_logs/{log_name}"

log_name2 = "modified_pso2024-03-18_12-52-28.json"
log_file2 = f"/home/leev/simulation_logs/{log_name2}"

log_name3 = "frontier_pso2024-03-18_12-36-29.json"
...
def main():
    ...
    plt.ylabel("Процент исследования, %")
    plt.show()
    ...
    plt.xlabel("Время симуляции, с")
    plt.ylabel("Средний пройденный путь, м")
    plt.show()
